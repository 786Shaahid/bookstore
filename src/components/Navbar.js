...
function Navbar() {
  return (
    <nav className='w-full  sticky top-0  bg-slate-800 border-b-gray-500 border-b-2 shadow-xl  h-20 md:h-30 flex  justify-start   items-center md:text-center px-4 py-4'  id="Scroll">
